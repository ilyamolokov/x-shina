...
export const CatalogCategoryContainer = observer(() => {
    ...
    return (
        <CatalogCategory categoryProperties={categoryProperties} categoryChildren={sortedNestedChildren} onForwardClick={handleForwardClick} onBackClick={handleBackClick} />
    );
})
